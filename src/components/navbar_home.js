  ...
  return (
    ...
    <nav className="fixed left-0 right-0 top-0 z-10  mx-auto max-w-full overflow-hidden border-[1px] border-blue-300 bg-[#cee1ee] backdrop-filter backdrop-blur-lg backdrop-saturate-150  md:rounded-b-xl">
      <div className="flex items-center justify-between px-5 py-5">
        ...
        <span className="pointer-events-none relative left-0 top-[50%] z-10 text-4xl font-black text-blue-900 mix-blend-overlay md:absolute md:left-[50%] md:-translate-x-[50%] md:-translate-y-[50%]">ATFE</span>
        <div className="flex items-center gap-4">
          <div className="hidden md:block">
          <Link to='/dashboard'> 
            <button 
              className="group relative overflow-hidden rounded-full px-4 py-2 transition-all hover:shadow-lg active:scale-95 text-gray-700  bg-opacity-20 backdrop-filter backdrop-blur-lg"
            >
      ...
      >
        ...
        <img
          ...
          >
            <span className="relative z-10 transition-colors group-hover:text-gray-900">Sign in</span>
          </button>
        </div>
      </motion.div>
    </nav>
